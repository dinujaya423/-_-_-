...
console.log('DINU-MD CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ 𝚂𝚁_𝙳𝙸𝙽𝚄_𝙼𝙳 ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ 𝑆𝑅 亇𝛯𝑆𝐻 _ 𝐷𝐼𝚴び ✅*


*YOUR BOT ACTIVE NOW ENJOY♥️🪄*\n\n*PREFIX: ${prefix}*

*╰──────────────●●►*`;
conn.sendMessage(conn.user.id, { image: { url:"https://files.catbox.moe/r8wree.jpg"config.MENU_IMG }, caption: up })
...
if(senderNumber.includes("94740026280")){
if(isReact) return
m.react("🦋")
   }
...
app.get("/", (req, res) => {
res.send("HEY, 𝚂𝚁_𝙳𝙸𝙽𝚄_𝙼𝙳 STARTED ✅");
});
